...
public class MyHistory_Item {
    ...
    public MyHistory_Item(String Author_WorkID, String Author_Name, String Date, String Title, String Content, String Desc, String Image, String F_Master_ID) {
