...
public class IssueVoicePlay extends RelativeLayout {
    ...
    public void SetVoicePath(String VoicePath) {
        ...
        try {
            ...
            View v = mInflater.inflate(com.apps.fae.R.layout.issue_file_item_voice, this, true);
            TextView txt_Voice = (TextView) v.findViewById(com.apps.fae.R.id.txt_Voice);
            txt_Voice.setText(String.valueOf(mediaPlayer.getDuration() / 1000) + "Second");
            final ImageView btn_Play = (ImageView) v.findViewById(com.apps.fae.R.id.btn_Play);
            mediaPlayer.setOnCompletionListener(new OnCompletionListener() {
                @Override
                public void onCompletion(MediaPlayer mp) {
                    //mp.stop();
                    btn_Play.setBackgroundResource(com.apps.fae.R.mipmap.newissue_btn_play);
                    Log.w("Stop", "AutoStop");
                }
            });
        ...
        btn_Play.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!mediaPlayer.isPlaying()) {
                    ...
                    btn_Play.setBackgroundResource(com.apps.fae.R.mipmap.newissue_btn_stop);
