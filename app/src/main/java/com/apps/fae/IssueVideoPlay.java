...
public class IssueVideoPlay extends RelativeLayout {
    ...
    public void SetVideoPath(String VideoPath) {
        ...
        View v = mInflater.inflate(com.apps.fae.R.layout.activity_issue_video_play, this, true);

        txt_Video_Name = (TextView) v.findViewById(com.apps.fae.R.id.txt_Video_Name);
