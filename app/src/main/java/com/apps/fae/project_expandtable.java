...
public class project_expandtable extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.apps.fae.R.layout.activity_project_expandtable, container, false);

        pDialog = new ProgressDialog(getContext());

        ProjectContext = getActivity();

        mSwipeRefreshLayout = (SwipeRefreshLayout) v.findViewById(com.apps.fae.R.id.refresh_layout);
        ...
        elv = (ExpandableListView) v.findViewById(com.apps.fae.R.id.mExpandableListView);
        ...
        */
        ...
        public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView,
            ...
            Glide.with(context)
                    ...
                    .asBitmap()
                    .placeholder(com.apps.fae.R.mipmap.logo_dragon)
                    .error(com.apps.fae.R.mipmap.logo_dragon)
...
//獲取一級清單佈局檔,設置相應元素屬性
            LinearLayout linearLayout = (LinearLayout) layoutInflater.inflate(com.apps.fae.R.layout.group, null);
            TextView textView = (TextView) linearLayout.findViewById(com.apps.fae.R.id.group_tv);
