...
public class MemberAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = mLayInf.inflate(com.apps.fae.R.layout.member_item, parent, false);

        if (Member_List.get(position).GetSection()) {
            v = mLayInf.inflate(com.apps.fae.R.layout.member_section, parent, false);

            TextView txt_Member_Title = (TextView) v.findViewById(com.apps.fae.R.id.txt_Member_Title);
...

        {
            ...
            ImageView Img_Member = (ImageView) v.findViewById(com.apps.fae.R.id.Img_Member);

            ImageView Img_Member_Phone = (ImageView) v.findViewById(com.apps.fae.R.id.Img_Member_Phone);

            TextView txt_Member_Name = (TextView) v.findViewById(com.apps.fae.R.id.txt_Member_Name);

            TextView txt_Member_Phone = (TextView) v.findViewById(com.apps.fae.R.id.txt_Member_Phone);
