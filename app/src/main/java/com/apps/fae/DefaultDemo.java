...
public class DefaultDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.fae.R.layout.activity_default_demo);


        IssueVideoPlay IssueVideoPlay = (IssueVideoPlay) findViewById(com.apps.fae.R.id.IssueVideoPlayGo);
