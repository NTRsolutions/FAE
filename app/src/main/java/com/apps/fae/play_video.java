...
public class play_video extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.fae.R.layout.activity_play_video);
...
// Prepare the player with the source.
            ...
            SimpleExoPlayerView simpleExoPlayerView = (SimpleExoPlayerView) findViewById(com.apps.fae.R.id.player_view);
