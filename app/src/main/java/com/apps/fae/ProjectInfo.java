...
public class ProjectInfo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.apps.fae.R.layout.activity_project_info);
        ...
        final ImageView Img_Star = (ImageView) findViewById(com.apps.fae.R.id.Img_Star);
                ...
                if (UserData.WorkID != "") {
                    ...
                    if (Img_Star.getDrawable() != null) {
                        if (Img_Star.getDrawable().getConstantState() != null) {
                            if (Img_Star.getDrawable().getConstantState() == getResources().getDrawable(com.apps.fae.R.mipmap.btn_star_nor).getConstantState()) {
                                Img_Star.setImageResource(com.apps.fae.R.mipmap.btn_star_sel);
                            } else {
                                Img_Star.setImageResource(com.apps.fae.R.mipmap.btn_star_nor);
                            }
                        } else {
                            Img_Star.setImageResource(com.apps.fae.R.mipmap.btn_star_nor);
                        }
        ...
        ImageView Img_Issue_List = (ImageView) findViewById(com.apps.fae.R.id.Img_Issue_List);
        ...
        ImageView Img_Spec = (ImageView) findViewById(com.apps.fae.R.id.Img_Spec);
        ...
        ImageView Img_Member = (ImageView) findViewById(com.apps.fae.R.id.Img_Member);
        ...
        ImageView Img_New_Issue = (ImageView) findViewById(com.apps.fae.R.id.Img_New_Issue);
    ...
    private void ModelData_Detail(JSONObject result) {
        ...
        try {
            ...
            if (UserArray.length() > 0) {
                ...
                final ImageView Img_Project_Pic_Large = (ImageView) findViewById(com.apps.fae.R.id.Img_Project_Pic_Large);

                //final LinearLayout Rel_Project_Layout = (LinearLayout) findViewById(R.id.Rel_Project_Layout);

                TextView txt_ProjectInfo_Name = (TextView) findViewById(com.apps.fae.R.id.txt_ProjectInfo_Name);

                TextView txt_ProjectInfo_Rate = (TextView) findViewById(com.apps.fae.R.id.txt_ProjectInfo_Rate);

                TextView txt_Model_Stage = (TextView) findViewById(com.apps.fae.R.id.txt_Model_Stage);

                TextView txt_Model_MarketName = (TextView) findViewById(com.apps.fae.R.id.txt_Model_MarketName);

                TextView txt_Model_Priority = (TextView) findViewById(com.apps.fae.R.id.txt_Model_Priority);
                ...
                try {
                    ...
                    if (CloseRate * 100 < 80) {
                        txt_ProjectInfo_Rate.setTextColor(getResources().getColor(com.apps.fae.R.color.ProjectInfo_WarningColor));
                    }
                ...
                ImageView Img_Star = (ImageView) findViewById(com.apps.fae.R.id.Img_Star);
