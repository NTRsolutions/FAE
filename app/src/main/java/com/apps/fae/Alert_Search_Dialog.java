...
public class Alert_Search_Dialog extends Dialog implements View.OnClickListener {
    ...
    public Alert_Search_Dialog(Context context, String Title, List<List_Item> DataList) {
        ...
        filterText = (EditText) findViewById(com.apps.fae.R.id.EditBox);
        filterText.addTextChangedListener(filterTextWatcher);
        list = (ListView) findViewById(com.apps.fae.R.id.List);
        ...
        txt_Reason.setBackgroundResource(com.apps.fae.R.drawable.edittextnormalcolor);

        Button Btn_Finish = (Button) findViewById(com.apps.fae.R.id.Btn_Finish);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(SelectValue)) {
                    if (!TextUtils.isEmpty(txt_Reason.getText().toString())) {
                        ...
                        txt_Reason.setBackgroundResource(com.apps.fae.R.drawable.edittextwarningcolor);
                    }
        ...
        Button Btn_Cancel = (Button) findViewById(com.apps.fae.R.id.Btn_Cancel);
