...
public class UploadFileProgress implements UploadStatusDelegate {
    ...
    class UploadProgressViewHolder {
        ...
        @BindView(com.apps.fae.R.id.uploadTitle)
        TextView uploadTitle;
        @BindView(com.apps.fae.R.id.uploadProgress)
        ...
        UploadProgressViewHolder(View view, String filename) {
            ...
            uploadTitle = (TextView) itemView.findViewById(com.apps.fae.R.id.uploadTitle);
            progressBar = (ProgressBar) itemView.findViewById(com.apps.fae.R.id.uploadProgress);
...
//        uploadProgressHolders.remove(uploadInfo.getUploadId());
    ...
    private void addUploadToList(String uploadID, String filename) {
        ...
        View uploadProgressView = inflater.inflate(com.apps.fae.R.layout.view_upload_progress, null);
