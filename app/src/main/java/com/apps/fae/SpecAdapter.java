...
public class SpecAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = mLayInf.inflate(com.apps.fae.R.layout.spec_item, parent, false);


        TextView txt_Spec_ComponentName = (TextView) v.findViewById(com.apps.fae.R.id.txt_Spec_ComponentName);
        TextView txt_Spec_ComponentContent = (TextView) v.findViewById(com.apps.fae.R.id.txt_Spec_ComponentContent);
